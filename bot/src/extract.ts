...
export interface Parsed {
  ...
  pairGroup?: "pons25"      // launches: filter to any Pons25 pairing token
...
export async function extract(text: string, savedWallet?: string, mode: Mode = "wallet"): Promise<Parsed> {
  ...
  return {
    ...
    pairGroup: intent === "launches" && pons25 ? "pons25" : undefined,
    onlyGraduated: intent === "launches" && graduatedWord ? true : undefined,
    unknownSymbol,
  }
}
